...
divergent       equ     scale * 4
	...
	ld hl, x_step
        ld (hl), low(6  * scale / 200)        ; x-coordinate step-width
	inc hl
	ld (hl), high(6  * scale / 200)        ; x-coordinate step-width	
	...
	ld hl, y_step
        ld (hl), low(960 / 120)         ; y-coordinate step-width
	inc hl
        ld (hl), high(960 / 120)         ; y-coordinate step-width
